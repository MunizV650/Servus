...
import 'page_criar_conta_model.dart';
export 'page_criar_conta_model.dart';

class PageCriarContaWidget extends StatefulWidget {
  const PageCriarContaWidget({super.key});

  static String routeName = 'PageCriarConta';
  static String routePath = '/pageCriarConta';

  @override
  State<PageCriarContaWidget> createState() => _PageCriarContaWidgetState();
}

class _PageCriarContaWidgetState extends State<PageCriarContaWidget>
    with TickerProviderStateMixin {
  late PageCriarContaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageCriarContaModel());
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    enabledBorder: OutlineInputBorder(
                                      borderSide: BorderSide(
                                        color:
                                            FlutterFlowTheme.of(context).corBtn,
                                        width: 2.0,
                                      ),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  autofillHints: [AutofillHints.password],
                                  obscureText:
                                      !_model.txtConfirmarSenhaVisibility,
                                  decoration: InputDecoration(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    context.pushNamedAuth(
                                        PageCriarContaWidget.routeName,
                                        context.mounted);

                                    await TbusuarioTable().insert({
                                      'memnom':
                                  ...
                                  options: FFButtonOptions(
                                    ...
                                    iconPadding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 0.0),
                                    color: FlutterFlowTheme.of(context).corBtn,
