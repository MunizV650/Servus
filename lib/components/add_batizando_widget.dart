...
import 'add_batizando_model.dart';
export 'add_batizando_model.dart';

class AddBatizandoWidget extends StatefulWidget {
  const AddBatizandoWidget({super.key});

  @override
  State<AddBatizandoWidget> createState() => _AddBatizandoWidgetState();
}

class _AddBatizandoWidgetState extends State<AddBatizandoWidget>
    with TickerProviderStateMixin {
  late AddBatizandoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddBatizandoModel());
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await TbbatizandoTable().insert({
                                ...
                                'batreg': _model.textFieldRGTextController.text,
