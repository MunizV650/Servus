...
import 'add_membro_widget.dart' show AddMembroWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class AddMembroModel extends FlutterFlowModel<AddMembroWidget> {
  ...
  bool isDataUploading_uploadFotoEdit = false;
  FFUploadedFile uploadedLocalFile_uploadFotoEdit =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadFotoEdit = '';
