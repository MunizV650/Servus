...
abstract class FlutterFlowTheme {
  ...
  late Color corBtn;
  late Color header;
  late Color azulClaro;
  late Color azul;
  late Color verde;
  late Color laranja;
  late Color vermelho;
  late Color verdeClaro;
  late Color roxo;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText = const Color(0xFFE4E1E1);
  ...
  late Color corBtn = const Color(0xFF6220A9);
  late Color header = const Color(0xFF1096BD);
  late Color azulClaro = const Color(0xFF84CDE7);
  late Color azul = const Color(0xFF1E88E5);
  late Color verde = const Color(0xFF4CAF50);
  late Color laranja = const Color(0xFFFF9800);
  late Color vermelho = const Color(0xFFF44336);
  late Color verdeClaro = const Color(0xFF009688);
  late Color roxo = const Color(0xFF9C27B0);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color corBtn = const Color(0xFF88B741);
  late Color header = const Color(0xFFED5AFC);
  late Color azulClaro = const Color(0xFFC0F327);
  late Color azul = const Color(0xFFA0359A);
  late Color verde = const Color(0xFF935574);
  late Color laranja = const Color(0xFF7B6D2A);
  late Color vermelho = const Color(0xFF362FF7);
  late Color verdeClaro = const Color(0xFF59306F);
  late Color roxo = const Color(0xFFCA1582);
}
